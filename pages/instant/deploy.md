...
Example request:
    ...
    curl -X POST -d "api_key=API_KEY&api_token=API_TOKEN&admin_pass=myC0MP1EXpassW0RD&admin_user=jonathan&name=jonathans-server.fluidstack.io&plan=myServerID" https://infinity.fluidstack.io/api/deploy/single
...
Example request:
    ...
    curl -X POST -d "id=SERVERID&api_key=API_KEY&api_token=API_TOKEN" https://infinity.fluidstack.io/api/deploy/status
